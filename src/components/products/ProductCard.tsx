      ...
      <CardContent className="px-4 py-2">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="space-y-1">
            <div className=" font-semibold tracking-wide">{vehicle?.carMaker||"-" } {vehicle?.model||"-"}</div>
          ...
          <div className="flex items-center gap-2">
            <Select>
              <SelectTrigger withIcon={false} className="rounded-full size-9 ">
                <SelectValue placeholder={"A"} className="text-primary" />
              </SelectTrigger>
        ...
        <div className="flex w-full flex-col gap-2  ">
          <div className="text-xs text-muted-foreground">
            ...
            <div className="text-xs text-muted-foreground flex items-center gap-2">
              ...
              <p className="font-semibold text-primary">{new Date(vehicle?.acceptancePeriod).toLocaleDateString()}</p>
            </div>
          </div>
      </CardFooter>
    </Card>
